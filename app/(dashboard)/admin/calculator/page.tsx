    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-4xl mx-auto p-3 sm:p-6">
        <div className="bg-white rounded-lg shadow p-4 sm:p-6 mb-6">
          ...
          <p className="text-gray-600 mb-6">Calculate BMR, TDEE, and macro recommendations for your clients</p>
        ...
        {results && (
          <div className="bg-white rounded-lg shadow p-4 sm:p-6">
            <h3 className="text-xl font-bold text-[#1A2332] mb-4">Results</h3>
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                ...
                <div className="bg-[#E8DCC4] rounded-lg p-4">
                  <p className="text-sm text-gray-700 mb-1 font-medium">Target Calories</p>
              ...
              <div className="border-t pt-4">
                <h4 className="font-semibold text-[#1A2332] mb-3">Recommended Macros</h4>
              ...
              <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4 text-sm text-gray-700">
                ...
                <ul className="list-disc list-inside space-y-1 text-xs">
                  <li>BMR = Basal Metabolic Rate (calories burned at rest)</li>
                  <li>TDEE = Total Daily Energy Expenditure (with activity)</li>
                  <li>Protein: 2g per kg body weight for muscle building/retention</li>
                  <li>Fats: ~27.5% of calories for hormone health</li>
                  <li>Carbs: Remaining calories for energy</li>
                  <li>These are starting points - adjust based on results</li>
                </ul>
              </div>
            </div>
          </div>
